    ...
    <div className="consultorio__footer section__padding">
      ...
      <div className="consultorio__footer-links">
        <div className="consultorio__footer-links_logo">
          ...
          <p>
            Sarmiento 2224. Posadas, Mnes. Argentina, Todos los derechos
            reservados
          </p>
        </div>
        <div className="consultorio__footer-links_div">
          <h4>Redes</h4>
          <p>
            <a href="https://www.linkedin.com/in/brunomacieldev/">Linkedin</a>
          </p>
          <p>
            <a href="https://www.instagram.com/_brunomciel/">Portafolio</a>
          </p>
          <p>
            <a href="https://github.com/BrunoMacielDev">GitHub</a>
          </p>
          <p>
            <a href="mailto:brunomacielcf@gmail.com">Correo</a>
          </p>
        </div>
        <div className="consultorio__footer-links_div">
          <h4>Empresa</h4>
        ...
        <div className="consultorio__footer-links_div">
          ...
          <p>Sarmiento 2224. Posadas, Mnes. Argentina</p>
