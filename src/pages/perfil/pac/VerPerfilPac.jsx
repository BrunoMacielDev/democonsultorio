...
function VerPerfilPac() {
  ...
  const trae_datos = async () => {
    const datos_pac = await API.verPerfilPac(id_paciente);
  ...
  const handleSubmit = async () => {
    ...
    if (validateEmail(email)) {
      const response = await API.UpdatePerfilPac(id_paciente, datos_enviar);
      if (response.status) {
        toast({
              ...
              <form>
                ...
                <div className="form-item">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      setCobertura_medica(event.target.value)
                    }
                  >
                    <option value="" defaultValue={""}>
                      --Elegir una opcion
                ...
                <div className="flex">
                  <button type="button">
                    <Link to={"/auth-password/paciente/" + id_paciente}>
                ...
                <div className="deleteAccount">
                  <Link to={"/desactivar-cuenta/paciente/" + id_paciente}>
                    Desactivar cuenta
                  </Link>
                </div>
              </form>
